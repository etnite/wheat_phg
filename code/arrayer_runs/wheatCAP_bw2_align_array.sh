...
#SBATCH --array=1-36%6  #array range - can choose number simultaneous jobs with %, e.g. --array=1-12%4
...
script="/home/brian.ward/repos/wheat_phg/code/alignment/bowtie2_align_parallel.sh"
