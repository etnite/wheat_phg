...
iter_file="/home/brian.ward/repos/wheat_phg/sample_lists/KS_HRW_reform_samples.txt"
...
parallel -j $SLURM_NTASKS --delay 1 --joblog parallel_run.log sbatch -t 00:10:00 -N1 -n10 $script {} ::: "${iter[@]}"
